...
You may want to use different workflows and APIs based on Git information. To support this, ZEIT Now will deploy your app with the following built-in environment variables.
