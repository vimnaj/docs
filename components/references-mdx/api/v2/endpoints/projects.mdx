...
<Code lang="json">{`{
  ...
  "buildCommand": {
    "auto": false,
    "valueDetected": "yarn run build",
    "valueCurrent": "yarn run different-build"
  },
  "devCommand": {
    "auto": false,
    "valueDetected": "next -p $PORT",
    "valueCurrent": "yarn run different-dev"
  },
  "outputDirectory": {
    "auto": true,
    "valueDetected": ".next/static",
    "valueCurrent": ".next/static"
  },
  "updatedAt": 1555413045188,
