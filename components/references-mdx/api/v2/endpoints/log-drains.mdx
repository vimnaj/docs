...
Log Drains allow you to collect logs from your deployments. To enable Log Drains, you must setup a URL using your [OAuth2](/docs/api#endpoints/oauth2) app credentials so that it is associated with your app.
