...
- [Preview Deployments](/docs/v2/platform/glossary#preview-deployments) for **every push**.
- **[Production Deployments](/docs/v2/platform/glossary#production-deployments) for the most recent changes** from the default branch.
