...
As your project is built, logs from the build step are generated and stored indefinitely. You can find more information about this in the [Deployments](/docs/v2/platform/deployments/#build-time) section.
